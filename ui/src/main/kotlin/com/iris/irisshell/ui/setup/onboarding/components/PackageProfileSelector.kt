...
import androidx.compose.foundation.selection.Checkbox
import androidx.compose.foundation.selection.CheckboxDefaults
...
private fun ProfileOption(
    ...
    Surface(
        ...
        color = if (selected) IrisPrimary.copy(alpha = 0.08f) : IrisSurfaceVariant,
        modifier = Modifier
            .fillMaxWidth()
            .height(56.dp),
    ) {
